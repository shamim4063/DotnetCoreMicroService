...
builder.Services.AddUserManagementPersistence(builder.Configuration);
...
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblyContaining<GetMenuById>());
